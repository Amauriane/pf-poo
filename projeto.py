...
def escolha():
    input("Digite 1 para ser X ou 2 para ser O: ")
    if escolha == '1':
        app_x()
        iniciar_jogo()
    elif escolha == '2':
...
def iniciar_jogo():
    ...
    def vencedor(i):
        ...
        # Botão de jogar
        botao_jogar = Button(frame_baixo, command=start, text='Próxima rodada', height=1,  font=('Ivy 10 bold'), overrelief=RIDGE, relief='raised', bg=fundo, fg=co0 )
    ...
    def terminar():
        ...
        def jogar_denovo():
            ...
            # Chamdando a funçao iniciar o jogo
            iniciar_jogo()
